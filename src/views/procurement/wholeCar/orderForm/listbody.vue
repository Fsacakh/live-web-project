    ...
    <div class="row">
        <div class="col-md-12">
            <b-card>
                <div class="row">
                    <div class="col-md-12">
                        <b-button size="sm" v-if="addBtn" variant="success" @click="transfer">新建采购单</b-button>
                ...
                <div class="table-scrollable">
                    <b-table striped hover bordered show-empty :items="dataList" :fields="fields">
                        ...
                        <template slot="carOpvName" slot-scope="data">
                            {{ data.item.totalMoney | toFixed(2) }}
                        </template>
...
<script>
    ...
    export default {
        ...
        computed: {
            addBtn() {
                return hasBtn(apiUrl.supplyChain.procurement.saveProcurementNum)
            }
        },
        mounted() {
        ...
        methods: {
            ...
            transfer() {
                this.$router.push({
                    path : `/procurement/intoTicket`
                })
            },
            showDetail(orderNo) {
                const _this = this
                _this.$router.push({
                   path: '/procurement/editTicket/' + orderNo
                })
            },
            pageChange(page) {
                const _this = this
                ...
                api.supplyChain.procurement.queryWholeCarByPages(options, function(res){
