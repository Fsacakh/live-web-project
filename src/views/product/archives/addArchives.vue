<template>
    <div class="animated fadeIn">
        <b-card header="基本信息">
            ...
            <iris-car :col="2" :initData="intentionCarInfoVos[0]" :disabled="true" ref="car" @callBack="back" @validete="validateCar"></iris-car>
        </b-card>
        <b-card header="采购信息">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <b-form-fieldset horizontal label="采购/核算单位转换系数" :label-cols="4" class="text-right">
                        <b-form-input v-model="edit.purchaseToCheckNums"/>
                    </b-form-fieldset>
                </div>
                <div class="col-md-6">
                    <b-form-fieldset horizontal label="标准成本" :label-cols="4" class="text-right">
                        <b-form-input v-model="edit.standardCost"/>
                    </b-form-fieldset>
                </div>
            </div>
        </b-card>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            //         this.edit.carFactoryCode = this.factoryCode.factoryCode
            //         this.edit.carFactoryName = this.factoryCode.factoryName
            ...
            //         this.edit.carBrandCode = this.brandCode.brandCode
            //         this.edit.carBrandName = this.brandCode.brandName
            ...
            //         this.edit.carSeriesCode = this.seriesCode.seriesCode
            //         this.edit.carSeriesName = this.seriesCode.seriesName
            ...
            //         this.edit.carModelCode = this.modelCode.modelCode
            //         this.edit.carModelName = this.modelCode.modelName
            ...
            //     if (this.opvCode) {
            //         this.iotype = false
            //         this.parameter.carIotype.code = this.opvCode.opvCode
            //         this.edit.carOpvCode = this.opvCode.opvCode
            //         this.edit.carOpvName = this.opvCode.opvName
            //         this.getCarTypeInfo(this.parameter.carIotype)
            //     }
            // },
            // iotypeCode:function () {
            //     if (this.iotypeCode) {
            //         this.edit.carIotypeCode = this.iotypeCode.iotypeCode
            //         this.edit.carIotypeName = this.iotypeCode.iotypeName
            //     }
            // },
            carCode: function () {
                if (this.carCode) {
