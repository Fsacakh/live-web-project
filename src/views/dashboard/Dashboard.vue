<template>
  <div class="animated fadeIn">
      ...
      <div class="col-sm-6 col-lg-3">
        <b-card class="bg-primary" :no-block="true">
          <div class="card-body pb-0">
            ...
            <h5 class="mb-2 text-center">进店客流数</h5>
      ...
      <div class="col-sm-6 col-lg-3">
        <b-card class="bg-info" :no-block="true">
          <div class="card-body pb-0">
            ...
            <h5 class="mb-2 text-center">订单数</h5>
      ...
      <div class="col-sm-6 col-lg-3">
        <b-card class="bg-warning" :no-block="true">
          <div class="card-body pb-0">
            ...
            <h5 class="mb-2 text-center">合同数</h5>
      ...
      <div class="col-sm-6 col-lg-3">
        <b-card class="bg-danger" :no-block="true">
          <div class="card-body pb-0">
            ...
            <h5 class="mb-2 text-center">车辆库存</h5>
    ...
    <b-card>
      <div class="row">
        <div class="col-sm-5">
          <h4 class="card-title mb-2">当月交车总览</h4>
          <div class="small text-muted">Jan 18 2018</div>
        </div><!--/.col-->
