<template>
    <b-modal @show="showbefor" id="insert1" title="新增联系人信息" size="lg" @ok="handleOk" ok-title="确定" cancel-title="取消">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
        ...
        methods: {
            handleOk(evt) {
                ...
                api.ordinalInfo.getSequence({
                    serviceCode: config.client.clientlinkmancode
                }, (msg) => {
                    if (msg.data.code == 'success') {
                        this.params.contactCode = msg.data.obj
                        api.clientadmin.clientcontacts.addclientcontacts(this.params, (msg) => {
                            if (msg.data.code == 'success') {
