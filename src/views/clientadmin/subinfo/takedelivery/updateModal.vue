<template>
    <b-modal @show="showbefor" id="updata4" ref="updata" @shown="showmodal" title="编辑收货信息" size="lg" @ok="handleOk" ok-title="确定" cancel-title="取消">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
    ...
    export default {
        ...
        methods: {
            ...
            handleOk(evt) {
                ...
                api.clientadmin.clientreceiver.updataclientreceiver(this.params, (msg) => {
            ...
            showmodal() {
                if (!this.amendclientreceiverdata) {
        ...
        computed: {
            ...mapState('clientmaininfo', [
                'amendclientreceiverdata',
            ]),
        },
        watch: {
            amendclientreceiverdata: function() {
                api.clientadmin.clientreceiver.querydetailedclientreceiver({
                    receiverCode: this.amendclientreceiverdata,
                }, (msg) => {
                    if (msg.data.code == 'success') {
                        ...
                        this.params = {
                            ...
                            receiverMobilePhone: data.receiverMobilePhone, //收货人手机号
                            receiverPhone: data.receiverPhone, //收货人电话号
                            address: data.address, //联系地址
                            postalCode: data.postalCode, //邮政编码
                            customCode: data.customCode, //客户编码
                            receiverCode: data.receiverCode, //收货信息编码
                            id: data.id,
