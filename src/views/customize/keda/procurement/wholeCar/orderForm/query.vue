                ...
                <div class="row">
                    <div class="col-md-6">
                        <b-form-fieldset horizontal label="额度类型" :label-cols="4" class="text-right">
                            <b-form-select v-model="queryParams.accountPeriodCode" :options="limitTypes"></b-form-select>
                        </b-form-fieldset>
                    </div>
                </div>
    ...
    methods: {
        ...
        query() {
            ...
            const option = {
                ...
                // 'productionCode': _this.queryParams.productionCode,
                // 'carVinNo': _this.queryParams.carVinNo,
            ...
            api.supplyChain.keda.purchaseOrder.queryPurchaseOrderInfo(option, function(res){
                if(res.data.code === 'success') {
        ...
        reset() {
            ...
            // this.queryParams.carVinNo = ''
            // this.queryParams.productionCode = ''
            ...
            this.queryParams.accountPeriodCode = ''
