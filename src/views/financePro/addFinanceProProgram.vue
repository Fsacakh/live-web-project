                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="首付类型" label-text-align="right" :label-cols="4">
                                    <b-form-select :options="isPercentTypes" v-model="financeProDetails[0].downpaymentType">
                                    </b-form-select>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="尾款类型" label-text-align="right" :label-cols="4">
                                    <b-form-select :options="isPercentTypes" v-model="financeProDetails[0].bpIsPercent">
                                    </b-form-select>
                                </b-form-fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="首付下限" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="downpaymentMinState" type="number" placeholder="" v-model="financeProDetails[0].downpaymentMin"/>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="尾款下限" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="balancePaymentMinValueState" type="number" placeholder="" v-model="financeProDetails[0].balancePaymentMinValue"/>
                                </b-form-fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="首付上限" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="downpaymentMaxState" type="number" placeholder="" v-model="financeProDetails[0].downpaymentMax"/>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="尾款上限" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="balancePaymentMaxValueState" type="number" placeholder="" v-model="financeProDetails[0].balancePaymentMaxValue"/>
                                </b-form-fieldset>
                            </div>
                        </div>
                    </b-card>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="期数(月)" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="cycleMonthState" type="number" placeholder="" v-model="financeProDetails[0].cycleMonth"/>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="利率/费率" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="ratesState" type="number" placeholder="" v-model="financeProDetails[0].rates"/>
                                </b-form-fieldset>
                            </div>
                        </div>
                        <div class="row" v-show="isLease">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="保值金类型" label-text-align="right" :label-cols="4">
                                    <b-form-select :options="isPercentTypes" v-model="financeProDetails[0].evIsPercent">
                                    </b-form-select>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="保证金类型" label-text-align="right" :label-cols="4">
                                    <b-form-select :options="isPercentTypes" v-model="financeProDetails[0].dfInPercent">
                                    </b-form-select>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="保证金金额" label-text-align="right" :label-cols="4">
                                    <b-form-input type="number" v-model="financeProDetails[0].depositFree"/>
                                </b-form-fieldset>
                            </div>
                        </div>
                        <div class="row" v-show="isLease">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="期末里程数" label-text-align="right" :label-cols="4">
                                    <b-form-input type="number" v-model="financeProDetails[0].finalMileage">
                                    </b-form-input>
                                </b-form-fieldset>
                            </div>
                        </div>
                    </b-card>
                    <b-card header="贴息" v-if="!isStandard">
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="机构贴息类型" label-text-align="right" :label-cols="4">
                                    <b-form-select v-if="isInterSubsidyMapEmpty" :options="isPercentTypes" v-model="financeProDetails[0].tDetailIntersubsidyInfoList[0].isPercent"/>
                                    <b-form-select v-else :options="isPercentTypes" v-model="interSubsidyIsPercent"/>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="经销商贴息类型" label-text-align="right" :label-cols="4">
                                    <b-form-select :options="isPercentTypes" v-model="financeProDetails[0].tDetailIntersubsidyInfoList[0].dealerInPercent"></b-form-select>
                                </b-form-fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="机构贴息数值" label-text-align="right" :label-cols="4">
                                    <b-form-input type="number" v-if="isInterSubsidyMapEmpty" placeholder="" v-model="financeProDetails[0].tDetailIntersubsidyInfoList[0].intersubsidyValue"/>
                                    <select class="form-control" v-else v-model="financeProDetails[0].tDetailIntersubsidyInfoList[0].intersubsidyValue">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="经销商贴息数值" label-text-align="right" :label-cols="4">
                                    <b-form-input type="number" placeholder="" v-model="financeProDetails[0].tDetailIntersubsidyInfoList[0].dealerIntersubsidyValue"/>
                                </b-form-fieldset>
                            </div>
                        </div>
                    </b-card>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="手续费类型" label-text-align="right" :label-cols="4">
                                    <b-form-select v-if="isServiceChargeMapEmpty" :options="isPercentTypes" v-model="financeProDetails[0].scIsPercent"/>
                                    <b-form-select v-else :options="isPercentTypes" v-model="serviceChargeIsPercent"/>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="手续费金额" label-text-align="right" :label-cols="4">
                                    <b-form-input type="number" v-if="isServiceChargeMapEmpty" v-model.number="financeProDetails[0].scValue"/>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="推荐权重" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="priorityLevelState" type="number" v-model="financeProDetails[0].tDetailCarInfoList[0].priorityLevel" placeholder="1~99">
                                    </b-form-input>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="方案状态" label-text-align="right" :label-cols="4">
                                    <b-form-select :options="onOffFlags" v-model="financeProDetails[0].onOffFlag"></b-form-select>
                                </b-form-fieldset>
                            </div>
                        </div>
                        <div class="row">
...
<script>
    ...
    export default {
        mounted() {
            ...
            this.getFinanceDetailCode()
            this.getFinanceOrgsServiceCharge({
                financeOrgCode: this.financeOrgCode
            })
            this.getFinanceOrgsIntersubsidy({
                financeOrgCode: this.financeOrgCode
            })
            this.getFinanceDetailCarCode()
            this.getFinanceDetailInterCode()
            this.getFinanceProInfo({
                financeCode: this.financeProDetails[0].financeCode
            })
        },
        data: function() {
            return {
