    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <b-card header="附加字段信息" class="mb-3" v-show="showAdditionalField">
                    <b-tabs pills>
...
<script>
    ...
    export default {
        mounted() {
            ...
            if(this.addFinanceProSuccess) {
               this.initFinancePro()
               this.getFinanceProDetailInfoList({
                  financeCode: this.$data.financePro.financeCode,
