                        ...
                        <div class="row" v-show="isLease">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="保值金金额" label-text-align="right" :label-cols="4">
                                    <b-form-input type="number" placeholder="" v-model.number="financeProDetails[0].endingValue"/>
                                </b-form-fieldset>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <b-form-fieldset horizontal label="推荐权重" label-text-align="right" :label-cols="4">
                                    <b-form-input :state="priorityLevelState" type="number" min="1" max="99" v-model.number="financeProDetails[0].tDetailCarInfoList[0].priorityLevel" placeholder="1~99">
                                    </b-form-input>
                                </b-form-fieldset>
                            </div>
                            <div class="col-md-6 col-lg-6">
    ...
    export default {
        mounted() {
            ...
            _this.getFinanceProDetailInfo({
                ...
                callback: function(financeProDetail) {
                    _this.financeProDetails[0] = _this.filterIn(financeProDetail)
