<template>
  <div class="row warp">
    ...
    <div class="treepick-warp-container" v-if="show">
      <div class="treepick-warp-in-container">
  ...
  export default {
    ...
    methods: {
      ...
      reset() {
        ...
        if (this.availableType == 0) return
      ...
      selectValue: function() {
        for (var i = 0; i < this.options.length; i++) {
          if (this.options[i].value == this.selectValue) {
            ...
            if (this.selectData.value) this.$emit("select-change", this.treeData, this.selectData);
            else this.$emit("select-change", this.treeData, this.options);
            this.selectDat
            return;
          }
        }
